...
function Header() {
  ...
  function showHeader() {
    // function to show navigation menu in mobile view
    const header = document.querySelector('header');
    const btnMenu = document.querySelector('.btn-menu');
    const btnClose = document.querySelector('.btn-close-menu');

    header.classList.add('show-header');
    btnMenu.classList.add('hide-btn');
    btnClose.classList.remove('hide-btn');
  }

  function hideHeader() {
    // function to hide navigation menu in mobile view
    const header = document.querySelector('header');
    const btnMenu = document.querySelector('.btn-menu');
    const btnClose = document.querySelector('.btn-close-menu');

    header.classList.remove('show-header');
    btnMenu.classList.remove('hide-btn');
    btnClose.classList.add('hide-btn');
  }

  useEffect(() => {
    // On rendering, hide the header if it's showed
    hideHeader();
  });
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="btn-close-menu hide-btn"
        onClick={hideHeader}
